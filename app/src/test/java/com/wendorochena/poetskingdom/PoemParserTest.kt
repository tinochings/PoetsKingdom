...
class PoemParserTest {
    ...
    fun testParseSimplePoem(): Unit = runTest {
        var result = PoemXMLParser.parseSavedPoem("Search Test 1", mockContext,Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 1)
        assert(result[0].lines().size == 1)
        assert(result[0] == "I want you")

        result = PoemXMLParser.parseSavedPoem("This is search 1", mockContext,Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 1)
        assert(result[0].lines().size == 1)
        assert(result[0] == "This is an example of a very long exact search string that will be " +
                "tested in the same manner as the previous tests")

        result = PoemXMLParser.parseSavedPoem("Boundary Test 1", mockContext,Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 1)
        assert(result[0].lines().size == 1)
        assert(result[0] == "K-nearest neighbors, abbreviated to KNN for future mentions is a " +
        ...
        result = PoemXMLParser.parseSavedPoem("HELLO", mockContext,Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 1)
        assert(result[0].lines().size == 1)
        assert(result[0] == "Sdfdsfsd dsf")

        result = PoemXMLParser.parseSavedPoem("Load Default Test", mockContext, Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 1)
        assert(result[0].lines().size == 1)
    ...
    fun testComplexPoem() : Unit = runTest {
        val result = PoemXMLParser.parseSavedPoem("Boundary Test 2", mockContext,Dispatchers.IO)
        assert(result.isNotEmpty())
        assert(result.size == 10)
        assert(result[0].lines().size == 34)
        assert(result[0] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
        ...
        assert(result[1] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[2] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[3] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[4] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[5] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[6] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[7] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[8] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
        ...
        assert(result[9] == "Bcvbvnbsdfdsfdsfdsfdsfdsf\n" +
                "kkkdsfdsfdsfdsfsfsd fss\n" +
                "ksdfdsfdsfsdfdsfsdfsdfdsfsdfdsfsdfsdfsdfsdfsdfsdfdsdfsdfsdfdsf\n" +
                "kdsfsdfdsfdsfdsfdsfdsfdsfdsfdsfsdfds\n" +
                "kfsdfsdfsdfsdfds\n" +
    ...
    fun parseMultipleSimplePoems() : Unit = runTest() {
        ...
        assert(results[1].second[0] == "K-nearest neighbors, abbreviated to KNN for future mentions " +
