    ...
    companion object {
            ...
            when (typeFaceName) {
                ...
                "sourcesansproregular_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.sourcesansproregular_font
                    )
                }
                ...
                "alegreya_sans_sc_medium_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.alegreya_sans_sc_medium_font
                    )
                }
                ...
                "lucian_schoenschrift_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.lucian_schoenschrift_font
                    )
                }
                ...
                "typerighter_medium_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.typerighter_medium_font
                    )
                }
                ...
                "rm_typerighter_old_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.rm_typerighter_old_font
                    )
                }
                ...
                "lm_monocaps_regular_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.lm_monocaps_regular_font
                    )
                }
                ...
                "coolvetica_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.coolvetica_font)
                }

                "rimouski_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.rimouski_font)
                }

                "typerighter_old_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.typerighter_old_font)
                }

                "postit_penscript_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.postit_penscript_font)
                }

                "buche_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.buche_font)
                }

                "manheart_earthman_font" -> {
                    return ResourcesCompat.getFont(
                        applicationContext,
                        R.font.manheart_earthman_font
                    )
                }
                "woodland_font" -> {
                    return ResourcesCompat.getFont(applicationContext, R.font.woodland_font)
                }
                "dearest_winnie_font" -> {
        ...
        fun getTypeFace(typeFaceName: String): FontFamily {
            ...
            when (typeFaceName) {
                ...
                "coolvetica" -> {
                    return FontFamily(Font(R.font.coolvetica))
                }

                "rimouski" -> {
                    return FontFamily(Font(R.font.rimouski))
                }

                "typerighter_old" -> {
                    return FontFamily(Font(R.font.typerighter_old))
                }

                "postit_penscript" -> {
                    return FontFamily(Font(R.font.postit_penscript))
                }

                "buche" -> {
                    return FontFamily(Font(R.font.buche))
                }

                "manheart_earthman" -> {
                    return FontFamily(Font(R.font.manheart_earthman))
                }
                "woodland" -> {
                    return FontFamily(Font(R.font.woodland))
                }
                "dearest_winnie" -> {
